context('plot_EIC_detectedPeakwidth()')
...
test_that('plot feature', {
	...
	# result plot
  result_plot <- plot_EIC_detectedPeakwidth(EIC[1], cpdID=1, cpdName='testCpd 1', rt=3454.435, rtmin=3420., rtmax=3495., mzmin=464.195358, mzmax=464.204642)
